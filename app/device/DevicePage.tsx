...
export default function DevicePage() {
  ...
  return (
    ...
    >
      <div className="bg-gray-900 p-5 rounded-lg shadow-md text-center">
        <h1 className="text-green-400 text-2xl font-bold mb-10">
          Scan WhatsApp QR Code
        </h1>
        {error ? (
          <div className="flex flex-col justify-center items-center mb-10 space-y-2">
            <p className="text-red-500 font-semibold">
              Terjadi kesalahan saat mengambil kode QR.
            </p>
            <p className="text-red-500">
              Silakan coba lagi setelah membuka aplikasi WhatsApp Anda.
            </p>
          </div>
        ) : qrCode ? (
          <img
